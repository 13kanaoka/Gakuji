...
class CameraSentenceDetailPage extends StatefulWidget {
  ...
  const CameraSentenceDetailPage({
    super.key,
  ...
  @override
  State<CameraSentenceDetailPage> createState() => _CameraSentenceDetailPageState();
}

class _CameraSentenceDetailPageState extends State<CameraSentenceDetailPage> {
  ...
  @override
  void didUpdateWidget(covariant CameraSentenceDetailPage oldWidget) {
