...
class _KanaStudyWritingPainter extends CustomPainter {
  final List<List<WritingPoint>> strokes;
  final bool showGrid;

  const _KanaStudyWritingPainter(this.strokes, this.showGrid);
  ...
  @override
  bool shouldRepaint(covariant _KanaStudyWritingPainter oldDelegate) => true;
}
