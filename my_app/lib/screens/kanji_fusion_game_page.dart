...
class _KanjiFusionGamePageState extends State<KanjiFusionGamePage> {
  ...
  void _reviewIncorrectAnswers() {
    if (incorrectRounds.isEmpty) return;

    setState(() {
      rounds = List<KanjiFusionRound>.of(incorrectRounds);
      currentRoundIndex = 0;
      correctCount = 0;
      incorrectCount = 0;
      skippedCount = 0;
  ...
  Widget _optionRow({
    ...
    return SizedBox(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: onTap,
          splashColor: _accentColor.withOpacity(0.08),
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(GakujiRadius.pill),
                    border: Border.all(
                      color: _accentColor.withOpacity(0.34),
                      width: 1.2,
                    ),
                  ),
                  child: Text(
    ...
    return IgnorePointer(
      child: CustomPaint(
        painter: _NestedGroupOutlinePainter(
          ...
          fillColor: _accentColor.withOpacity(
                      ...
                      children: List.generate(formCount, (dotIndex) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isCurrent
                                ? _blockTextColor
                                : _blockOutlineColor.withOpacity(0.55),
                          ),
                        );
                      }),
                    ),
          ...
          children: [
            ...
            Expanded(
              child: _fusionComparisonCard(
                ...
                accentColor: _accentColor.withOpacity(0.82),
